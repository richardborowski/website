            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        <Nav.Link as={Link} to="/website/projects" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Projects</Nav.Link>
                        <Nav.Link as={Link} to="/website/nnbounding" className={activeLink === 'nnbounding' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('nnbounding')}>NNBounding</Nav.Link>
                    </Nav>
